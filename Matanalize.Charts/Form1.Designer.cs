...
namespace Matanalize.Charts
    ...
    partial class Form1
        ...
        private double _intervalStart = -2;
        private double _intervalEnd = 2;
        ...
        private void InitializePlotModel(PlotView plot, Func<double, double> func)
            ...
            model.Axes.Add(new OxyPlot.Axes.LinearAxis { Position = OxyPlot.Axes.AxisPosition.Left, ExtraGridlines = new double[] { 0 }, ExtraGridlineThickness = 1, ExtraGridlineColor = OxyColors.Black, });
            model.Axes.Add(new OxyPlot.Axes.LinearAxis { Position = OxyPlot.Axes.AxisPosition.Bottom, ExtraGridlines = new double[] { 0 }, ExtraGridlineThickness = 1, ExtraGridlineColor = OxyColors.Black, });
            plot.Model = model;
            }
